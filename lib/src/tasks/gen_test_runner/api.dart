...
Future<GenTestRunnerTask> genTestRunner(TestRunnerConfig currentConfig, {List<String> filesToInclude}) async {
  ...
  if (currentConfig.genHtml && !currentConfig.check) {
    await testHtmlFileGenerator(
        currentConfig.directory, currentConfig.filename, currentConfig.htmlHeaders);
  }
  ...
  testFiles.forEach((File file) {
    var testPath = file.path.replaceFirst(currentConfig.directory, '');
    runnerLines.add(
