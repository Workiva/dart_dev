...
class AnalyzeTool extends DevTool {
  ...
  /// Ignored. Analysis always uses `dart analyze`.
  @Deprecated(
    'dartanalyzer was removed from the SDK; dart analyze is always used',
  )
  bool? useDartAnalyze;
  ...
  String? get description =>
      super.description ?? 'Run static analysis on dart files in this package.';
